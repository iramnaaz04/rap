...
FORM U_COMM USING R_UCOMM LIKE SY-UCOMM RS_Selfield TYPE SLIS_SELFIELD.
  CASE R_UCOMM.
    WHEN 'SELECT'.
      LOOP AT IT_FINAL INTO WA_FINAL.
        WA_FINAL-CHECK = 'X'.
...
*        MOVE-CORRESPONDING WA_FINAL TO WA_ZTABLE.
*        WA_ZTABLE-BOM_COM = WA_FINAL-MAT3.
*
*        MODIFY ZDB_STD_MAT_PRD FROM WA_ZTABLE.
...
*CLEAR WA_DOWNLOAD  "aPPEND EACH RECORD.
      .
